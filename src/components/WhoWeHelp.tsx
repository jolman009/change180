      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {audiences.map((audience, index) => (
            ...
            >
              <div className="w-14 h-14 bg-sage-100 rounded-xl flex items-center justify-center mb-6 group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
        ...
        <motion.div
          ...
          className="mt-20 bg-sage-100 rounded-3xl p-10 md:p-16 text-center max-w-4xl mx-auto"
        >
